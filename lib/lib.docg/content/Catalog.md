...
This file must follow an strict structure. For more information check [Summary documentation in mdBook](https://rust-lang.github.io/mdBook/format/summary.html).

### Naming Convention

By default _Gungnir_ will sort items alphabetically by `<package>.docg` name. If you want specific sort you can name your file like `<nnn>-SUMMARY.md` were `<nnn>` corresponds to a number between 000 and 999. Example: `001-SUMMARY.md`.
